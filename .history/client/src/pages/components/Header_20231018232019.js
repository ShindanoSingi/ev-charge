  ...
  return (
    <div className=" flex flex-col tablet-landscape:items-center tablet-landscape:gap-2 p-2 gap-1 fixed z-10 w-full top-0 bg-[#262A34]">
      ...
      <div className="flex items-center ">
        <div className="w-full h-10 px-4 text-gray-400 border border-gray-400 rounded-lg "><fieldset className="w-full px-4 text-gray-400 border border-gray-400 rounded-lg ">
