...
function Header() {
  ...
  return (
    <div className=" flex flex-row tablet-landscape:items-center tablet-landscape:gap-2 p-2 gap-1 fixed z-10 w-full top-0 bg-[#262A34]">
      ...
      <div className=" w-[99vw] tablet-landscape:w-[50vw] flex items-center">
