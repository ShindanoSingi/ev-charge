...
const SignupForm = () => {
    ...
    return (
        <div className='absolute desktop-landscape:px-[30%] grid top-[30%] desktop-landscape:top-[30%] w-full tablet-landscape:top-[20%] tablet-landscape:bg-black tablet-landscape:px-[20%]'>
