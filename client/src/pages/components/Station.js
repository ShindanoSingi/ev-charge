...
function Station() {
    ...
    return (
        showCard && <div className='bg-[#181A20] w-[90%] md:w-[60%] lg:w-[50%] xl:w-[40%] center border-white border-solid border absolute z-50 top-[50%] right-4 rounded-lg left-4 translate-y-[-50%]'
            onClick={() => {
